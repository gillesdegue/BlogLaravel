...
<body>
    ...
    <div class="dashboard-main-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('htags') }}"  aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-hashtag"></i>Htags</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Gestion des htags </h2>
                            ...
                            <!-- ============================================================== -->
                             ...
                             <div id="htags" class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="card">
                                 ...
                                 <h5  class="card-header">Htags</h5>
                                 <div style="margin-left: 50%;width: 50%;">
                                    <form class="needs-validation" novalidate method="post" action="{{ route('rechercheHtags') }}" enctype="multipart/form-data" >
                                        {{ csrf_field() }}
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0" style="text-align: center;">modifier</th>
                                                ...
                                                <tbody>
                                                    <?php $i=0; ?>
                                                 @foreach ($htagsPagination as $htag)
                                                 <?php $i++; ?>
                                                  <tr>
                                                        <td> <?= $i ?></td>
                                                        <td>
                                                        ...
                                                        <td><button id="{{$htag->id}}" idr="{{$htag->libelle}}" class="btn btn-info btn-edit" type="button" data-toggle="modal" data-target="#popupHtag"  style="width: 50%;margin-left:25%;">modifier</button></td>
                                                        <td>
                                                            <form id="<?= $i ?>" method="get" action="{{'/suprimerHtag/'.$htag->id}}">
                                                            <button id="suppers" idr="<?= $i ?>" class="btn btn-danger btn-space"  class="supers" type="button" style="width: 50%;margin-left:25%;"data-toggle="modal" data-target="#suppTags"><i class="fas fa-trash-alt"></i></button>
                                                        </form>
                                                 ...
                                                 @endforeach
                                                    ...
                                                    <tr>
                                                        <td colspan="9"><span href="#" class="float-right">{{$htagsPagination->links()}}</span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
       ...
       <div class="modal fade" id="popupHtag" role="dialog">
                    ...
                    <div class="modal-body">
                       ...
                       <form class="needs-validation" novalidate method="post" action="{{ route('modifHtag') }}" enctype="multipart/form-data">
                                        <!--
                                    ...
                                    <input type="hidden" class="form-control" id="id_tags" name="id_tags" value="" required>
                                                <label  for="tag_libelle">libelle</label><br>
                                                <input  type="text"  style="width: 100%;height: 54%;padding-top: 0.5%;" class="form-group  mb-2" id="tag_libelle" name="tag_libelle" />
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary " type="submit"><i class="icon s7-mail"></i> Modifier</button>
            ...
            ************************************************************ -->
            <!-- ============================================================== --> 
         <div class="modal fade" id="suppTags" role="dialog">
                    ...
                    <div class="modal-body">
                        ...
                        <span style="margin-left: 5%;">vous etes sur de vouloir supprimer de htags?</span>
                        <br>
                     <button id="btnsupHtag"  class="btn btn-info btn-edit form-group" type="button"   style="width: 45%;margin-left: 5%;">confirmer</button>
...
$('#btnsupHtag').click(function(){
  document.forms[row_id].submit();
});
